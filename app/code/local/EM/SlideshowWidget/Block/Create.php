...
class EM_Slideshowwidget_Block_Create extends Mage_Core_Block_Template implements Mage_Widget_Block_Interface {
    ...
    protected function _toHtml() {
		$text1 = Mage::helper('core')->urlDecode(trim($this->getData('text1')));
		$text2 = Mage::helper('core')->urlDecode(trim($this->getData('text2')));
		$text3 = Mage::helper('core')->urlDecode(trim($this->getData('text3')));
		$text4 = Mage::helper('core')->urlDecode(trim($this->getData('text4')));
		$text5 = Mage::helper('core')->urlDecode(trim($this->getData('text5')));
		$text6 = Mage::helper('core')->urlDecode(trim($this->getData('text6')));
		$text7 = Mage::helper('core')->urlDecode(trim($this->getData('text7')));
		$text8 = Mage::helper('core')->urlDecode(trim($this->getData('text8')));
		$text9 = Mage::helper('core')->urlDecode(trim($this->getData('text9')));
